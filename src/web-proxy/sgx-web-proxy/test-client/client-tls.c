...
int main(int argc, char** argv)
{
    ...
    // ask user for website to navigate to
    char website[256];
    printf("Enter website to navigate to: ");
    fgets(website, sizeof(website), stdin);
    website[strcspn(website, "\n")] = 0;  // remove trailing newline

    // compose request with website as parameter 
    char http_request[512];
    snprintf(http_request, sizeof(http_request), "GET /?url=%s HTTP/1.0\r\n\r\n", website);
