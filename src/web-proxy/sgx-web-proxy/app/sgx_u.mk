...
SGX_WOLFSSL_LIB="../sgx-ra-tl/deps/wolfssl/IDE/LINUX-SGX"
...
App_Include_Paths := $(Wolfssl_Include_Paths) -I$(UNTRUSTED_DIR) -I$(SGX_SDK)/include -I$(SGX_RA_TLS_ROOT) -I../sgx-ra-tls/deps/local/include
...
App_Link_Flags := $(SGX_COMMON_CFLAGS) -L$(SGX_LIBRARY_PATH) -L$(SGX_RA_TLS_ROOT)/deps/local/lib -l$(Urts_Library_Name) -lpthread ../sgx-ra-tls/deps/local/lib/libcurl-wolfssl.a $(SGX_RA_TLS_ROOT)/deps/local/lib/libwolfssl.a -lz -lm
...
$(UNTRUSTED_DIR)/Enclave_u.c: $(SGX_EDGER8R) trusted/Enclave.edl
	@cd $(UNTRUSTED_DIR) && $(SGX_EDGER8R) --untrusted ../trusted/Enclave.edl --search-path ../trusted --search-path $(SGX_SDK)/include --search-path ../../sgx-ra-tls
	@echo "GEN  =>  $@"
...
App: $(UNTRUSTED_DIR)/Enclave_u.o $(App_C_Objects)
	@$(CC) $^ -o $@ $(App_Link_Flags)
	@echo "LINK =>  $@"
...
clean:
	@rm -f App $(App_C_Objects) $(UNTRUSTED_DIR)/Enclave_u.* 
